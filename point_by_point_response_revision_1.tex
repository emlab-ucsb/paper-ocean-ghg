...
Being able to infer vessel characteristics that are not available in registries is becoming increasingly important over time. The registry-matched share of AIS-broadcasting vessels falls from 30\% in 2017 to 17\% in 2025, because AIS adoption is spreading fastest among exactly those vessel types that are underrepresented in these registries. Each year, a larger share of the observable AIS-broadcast fleet can only be characterized by inferring their vessel characteristics, which is why we regard the vessel-characteristics models as a significant contribution of this work rather than just a workaround for missing data. We now report this trend in the Results.
