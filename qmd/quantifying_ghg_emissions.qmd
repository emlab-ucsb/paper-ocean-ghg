...
#| fig-cap: Spatial patterns of CO2 emissions in 2024 (top panel), and the change in CO2 emissions between 2016 and 2024 (bottom panel) (metric tonnes). Emissions are total aggregated across the AIS-broadcasting fleetand non-broadcasting fleet, and shown at a 1x1 degree spatial resolution.
#| fig-width: 6
#| fig-height: 4
...
annual_spatial_co2_emissions_ais_dark  |>
  ...
  scico::scale_fill_scico("CO2 emissions\n(MT)",
                          palette = "berlin",
                          midpoint = 0,
