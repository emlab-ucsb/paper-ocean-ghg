...
```{r}
#| label: fig-total-annual-unique-vessels-engine-power
#| fig-cap: Annual unique number of operating vessels (top panel); and annual total engine power for those vessels (killowatt). The percent change from 2015 to 2023 is shown next to each line.
#| fig-width: 7.5
#| fig-height: 4
...
annual_vessel_summary_by_year <- annual_ais_co2_emissions_by_vessel |>
  ...
  dplyr::mutate(name = ifelse(stringr::str_detect(name,"power"),"Total engine power (kW)","Number unique vessels"))
