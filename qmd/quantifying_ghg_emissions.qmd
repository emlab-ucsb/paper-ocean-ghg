...
emissions_comparison_figure_absolute <- all_tranportation_data_normalized |>
...
cowplot::plot_grid(emissions_comparison_figure_absolute,
                   emissions_comparison_figure_normalized,
                   ncol=1,align="vh",labels=c("A","B"))
```
...
time_series_by_vessel_type <- time_series_by_vessel_type_df  |>
  ...
  theme(panel.grid.minor.x = element_blank()) +
  geom_hline(yintercept = 0, linetype = 2) +
  scale_color_manual(values = c("lightgoldenrod4","lightgoldenrod3","slateblue3"))
