...
#| fig-cap: Relative predicted change in CO2 emissions from 2016 baseline, using the predicted model outputs of four different scenarios that look at the relative impact of changes in total hours (extensive margin) and changes in average speed (intensive margin).
#| fig-width: 7.5
#| fig-height: 4
...
final_annual_prediction_dataset |>
  ...
  labs(x = "",
       y = "Relative predicted change in CO2 emissions\nfrom 2016 baseline") +
  theme_plot() +
  theme(panel.grid.minor.x = element_blank())
```
