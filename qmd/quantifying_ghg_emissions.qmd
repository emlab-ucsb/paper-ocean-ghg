...
#| fig-cap: Annual distributions of individual vessel-level CO2 emissions (metric tonnes, top panel); operating hours (middle panel); and main engine power (panel). The point shows the mean value, and the error bars show +/- two standard errors.
#| fig-width: 7.5
#| fig-height: 5
...
#| fig-cap: Annual mean vessel-level CO2 emissions (metric tonnes, top panel); operating hours (middle panel); and main engine power (panel) for the set of AIS-broadcasting vessels that have been operating since a given year, where each line is colored by the earliest operation year. The percent change from the earliest year to 2023 is shown next to its line..
#| fig-width: 7.5
#| fig-height: 8
