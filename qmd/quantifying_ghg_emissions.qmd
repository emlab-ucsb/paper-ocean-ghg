...
time_series_predicted_decomposition <- final_annual_prediction_dataset |>
...
time_series_by_vessel_type <- annual_emissions |>
  ...
  theme(panel.grid.minor.x = element_blank()) +
  geom_hline(yintercept = 0, linetype = 2) +
  scale_color_manual(values = c("#a65628","#ff7f00","#7570b3"))
