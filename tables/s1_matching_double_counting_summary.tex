...
\addlinespace
S1-unmatched CO$_2$ that duplicates AIS-based CO$_2$, 2017--2025 & 137 million tonnes (1.2\% of combined total)\\
Increase in the emissions the model fits per detection & 5.4\%\\
Upper bound on S1-unmatched CO$_2$ that duplicates AIS-based CO$_2$, including that increase & 11.9\% of S1-unmatched CO$_2$ (2.4\% of combined total)\\
\bottomrule
\end{tabular}
\end{table}
